...
def get_dataset(args):
    ...
    if args.dataset == "cifar10":
        ...
        train_dataset = STL10(
            args.data_path, split="train", download=True, transform=transform
        )
        test_dataset = STL10(
            args.data_path, split="test", download=True, transform=transform
        )
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"/data/xzhong/ddpm/{args.dataset}_resnet34.pth")
